...
public class AddTeacher extends AppCompatActivity {
    ...
    private EditText addTeacherName, addTeacherEmail, addTeacherSubject;
    private Spinner addTeacherCategory;
    private Button addTeacherBtn;
    private final int REQ = 1;
    private Bitmap bitmap = null;
    private String category;
    private String name, email, subject, downloadUrl = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] items = new String[]{"Select Category", "PHYSICS XI-XII", "CHEMISTRY XI-XII", "MATHEMATICS XI-XII", "BIOLOGY XI-XII" , "ENGINEERING"};
    ...
    private void insertData() {
        ...
        TeacherData teacherData = new TeacherData(name, email, subject, downloadUrl,uniqueKey);
